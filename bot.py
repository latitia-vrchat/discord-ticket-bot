...
WORKING_DAYS = [0, 4, 5, 6]  # 週一、週五、週六、週日

# 工作時間設定（24小時制）
WORK_START = time(8, 0)  # 早上8:00開始工作
WORK_END = time(18, 0)    # 晚上6:00結束工作

# ===== 監控設定 =====
# 方式1：監控指定的類別名稱（Category）
...
# 方式3：監控 Forum 頻道（論壇）
MONITOR_FORUMS = True  # 設為 True 監控所有 Forum，設為 False 則不監控
